            ...
            <div className='container'>
                <div className='about__row'>
                    <div className='about__col' >
                        ...
                        <p className='text-light mt-30' data-aos="fade-up">
                        ...
                        <p className='text-light mt-10' data-aos="fade-up">
                    ...
                    <div className='about__col' data-aos="fade-up">
                        <h5 className='sub-title' data-aos="fade-up">Nega Vita Soft?</h5>
                        <ul className='about__list mt-30'>
                            <li className='about__list__item' data-aos="fade-up">

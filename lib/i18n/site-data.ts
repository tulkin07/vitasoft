...
export function useSiteData() {
  ...
  return {
    ...
    navLinks: [
      ...
      { href: "/#technologies", label: messages.nav.technologies },
    ...
    companyStats: messages.company.stats.map((s, i) => ({
      ...s,
      value: [50, 30, 4, 10, 24][i],
      suffix: ["+", "+", "+", "+", "/7"][i],
    })),
    heroStats: [
      { value: "50+", label: messages.company.heroStats[0].label },
      { value: "30+", label: messages.company.heroStats[1].label },
      { value: "5+", label: messages.company.heroStats[2].label },
      { value: "10+", label: messages.company.heroStats[3].label },
    ],
